    ...
    <body>
        ...
        <div id="contenido" class="">
            ...
            <form action="actualizar.php?id=<?php echo $Profesionista->id; ?>" method="POST">
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <label for="lenguas" class="form-label">Idiomas</label>
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <p class="text">Seleccione el Servicio</p>
                        <select class="form-control" name="servicio" id="servicio">
                        <?php foreach($servicio as $s){
                        ?>
                        <option value="<?php echo $s->idServicio; ?>"><?php echo $s->nomservicio; ?></option>
                        <?php
                            }
                        ?>
                    </select>
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <input type="reset" value="Limpiar" class="btn btn-outline-dark">
