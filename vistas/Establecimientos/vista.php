                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <img class="card-img-top" src="../../uploads/<?= $e->Foto ?>" alt="<?= $e->Nombre ?>" style="height: 50%; width: 100%;" />
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <button type="button" class="btn btn-outline-dark mt-auto" data-bs-toggle="modal" data-bs-target="#modal<?= $e->Id_Establecimiento ?>">
                                        Ver Establecimiento
                                    </button>
                                </div>
                            </div>
                                ...
                                <div class="modal-body">
                                    <div class="container px-4 px-lg-5 my-5">
                                        <div class="row gx-4 gx-lg-5 align-items-center">
                                            <div class="col-md-6">
                                                <img class="img-fluid rounded mb-4" src="../../<?= $e->Foto ?>" alt="Foto de <?= $e->Nombre ?>" />
                                            </div>
                                            <div class="col-md-6">
