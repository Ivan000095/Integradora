                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" name="password" id="password" value="<?= $Doctor->password ?>" required>
                        </div>
                        <br>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="idiomas" id="idiomas" value="<?= $Doctor-> idioma?>">
                        </div>
                        <br>
                        <div class="mb-3">
                            ...
                            <input class="form-check-input" type="radio" name="genero" id="genero_f" value="F"
                                <?php if ($Profesionista->genero == 'F') echo 'checked'; ?> required>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="genero" id="genero_m" value="M"
                                <?php if ($Profesionista->genero == 'M') echo 'checked'; ?>>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="genero" id="genero_nb" value="no binario"
                                <?php if ($Profesionista->genero == 'no binario') echo 'checked'; ?>>
                    ...
                    <div class="col-md-6">
                        <div class="md-3">
                            ...
                            <input type="date" class="form-control" name="fecha" id="fecha" value=" <?= $Doctor->fecha ?>" required>
                        </div>
                        <br>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="costo" id="costo"  value=" <?= $Doctor->costo ?>">
                        </div>
                        <br>
                        <div class="mb-3">
                ...
                <!-- Botones -->
                    <div class="row justify-content-center">
                        <div class="col-md-4 text-center">
                            <input type="reset" value="Limpiar" class="btn btn-outline-dark me-2">
